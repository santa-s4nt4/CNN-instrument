...
trains_dirname = os.path.join('dataset', 'labeled_piano', 'trains')
valids_dirname = os.path.join('dataset', 'labeled_piano', 'valids')
...
model_filename = os.path.join(
    'models', 'finding_piano_model_{val_loss:.2f}.h5')
...
predicting_dirname = os.path.join('dataset', 'reshaped_piano', '*')
predicted_dirname = os.path.join('dataset', 'predicted_piano')
