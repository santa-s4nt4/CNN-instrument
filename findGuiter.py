...
trains_dirname = os.path.join('dataset', 'labeled_guiter', 'trains')
valids_dirname = os.path.join('dataset', 'labeled_guiter', 'valids')
...
model_filename = os.path.join(
    'models', 'finding_guiter_model_{val_loss:.2f}.h5')
...
predicting_dirname = os.path.join('dataset', 'reshaped_guiter', '*')
predicted_dirname = os.path.join('dataset', 'predicted_guiter')
